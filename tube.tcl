# 
# Project automation script for tube 
# 
# Created for ISE version 10.1
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source tube.tcl, then you can
...
set myProject "tube.ise"
set myScript "tube.tcl"
...
proc add_source_files {} {
   ...
   xfile add "addrdecode.v"
   xfile add "cache.v"
   xfile add "common.vhd"
   xfile add "config.v"
   xfile add "fifo.v"
   xfile add "sdramburst.v"
   xfile add "sdramcntl.vhd"
   xfile add "system.ucf"
   xfile add "system.v"
   xfile add "test.v"
   xfile add "tube.v"
   xfile add "vga.v"
   xfile add "xsadualsdram.v"
   xfile add "xsasdramcntl.vhd"

   # Set the Top Module as well...
   project set top "system"
...
proc set_process_props {} {
   ...
   project set "SmartGuide Filename" "system_guide.ncd"
   ...
   project set "Perform Timing-Driven Packing" "false" -process "Map"
   ...
   project set "Number of PAR Iterations (0-100)" "5" -process "Place & Route"
